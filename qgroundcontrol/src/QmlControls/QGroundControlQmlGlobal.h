...
Q_MOC_INCLUDE("TargetFetchManager.h")
...
public:
    ...
    Q_PROPERTY(TargetFetchManager*  targetFetch             READ    targetFetch             CONSTANT)   ///< STRATUM: relayed XC25 target
    ...
    TargetFetchManager*     targetFetch         ()  { return _targetFetchManager; }
...
private:
    ...
    TargetFetchManager*     _targetFetchManager     = nullptr;
